...
<template>
    <AuthLayout>
        <Head title="Tasin Mobil — Täze parol" />

        <!-- Heading -->
        <div class="mb-7">
            <h3 class="text-[28px] font-extrabold text-ink dark:text-slate-100">Täze parol bellemek</h3>
            <p class="mt-1.5 text-sm text-muted dark:text-slate-400">
                Hasabyňyz üçin täze parol saýlaň.
            </p>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-5">
            ...
            <div>
                ...
                <div class="relative mt-1.5">
                    ...
                    <input
                        ...
                        :class="[fieldCls(!!form.errors.email), 'pl-10 pr-4 opacity-70 cursor-default']"
                    />
                </div>
            ...
            <div>
                ...
                <div class="relative mt-1.5">
                    ...
                    <input
                        ...
                        placeholder="Täze parol (azyndan 8 simwol)"
            ...
            <!-- Confirm password -->
            <div>
                <label for="password_confirmation" class="block text-sm font-bold text-ink dark:text-slate-300">
                    Paroly tassyklaň
                </label>
                <div class="relative mt-1.5">
                    <span class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-muted">
                    ...
                    <input
                        ...
                        required
                        autocomplete="new-password"
                        placeholder="Täze paroly gaýtalaň"
                        :class="[fieldCls(!!form.errors.password_confirmation), 'pl-10 pr-10']"
                    />
                    <button
                        type="button"
                        ...
                        tabindex="-1"
                    >
                        <svg v-if="showConfirm" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" />
                        </svg>
                        <svg v-else class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
            ...
            >
                ...
                {{ form.processing ? 'Täzelenýär…' : 'Paroly täzele' }}
            </button>
        </form>
    </AuthLayout>
</template>
